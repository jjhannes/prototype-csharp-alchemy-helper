...
public class BaseStaticDictionaryMediatorWithMorrowindRepoTester
{
    protected StaticDictionaryMediator _mediator { get; private set; }

    public BaseStaticDictionaryMediatorWithMorrowindRepoTester()
    {
        ILoggerFactory loggerFactory = LoggerFactory.Create(builder => builder.AddConsole());
        ILogger<StaticDictionaryMediator> logger = loggerFactory.CreateLogger<StaticDictionaryMediator>();
        this._mediator = new StaticDictionaryMediator(logger, new MorrowindRepo());
    }
}
